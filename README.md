...
```
cd existing_repo
git remote add origin https://gitlab.beyond-undefined.fr/bernard/pro/llama-test.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.beyond-undefined.fr/bernard/pro/llama-test/-/settings/integrations)
